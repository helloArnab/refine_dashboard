import {Box,Typography,FormControl,FormHelperText,TextField,TextareaAutosize,Stack,Button,MenuItem,Select} from '@pankod/refine-mui'
  ...
  return (
    <Box>
      ...
      <Box mt={2.5} borderRadius='15px' bgcolor="#fcfcfc" padding='20px'>
        ...
        >
          <FormControl>
            <FormHelperText sx={{fontWeight: 500,fontSize:16,color:"#11142d",margin:'16px'}}>Enter property name</FormHelperText>
            <TextField 
              fullWidth
              required
              id='outlined-basic'
          ...
          <FormControl>
            <FormHelperText sx={{fontWeight: 500,fontSize:16,color:"#11142d",margin:'16px'}}>Enter Description</FormHelperText>
            <TextareaAutosize
              minRows={5}
              required
          ...
          <Stack direction="row" gap={4}>
            ...
            <FormControl>
              <FormHelperText sx={{fontWeight: 500,fontSize:16,color:"#11142d",margin:'10px 0'}}>Enter property price</FormHelperText>
                <TextField 
                  fullWidth
                  required
                  id='outlined-basic'
          ...
          <FormControl>
              <FormHelperText sx={{fontWeight: 500,fontSize:16,color:"#11142d",margin:'10px 0'}}>Enter Location</FormHelperText>
                <TextField 
                  fullWidth
                  required
                  id='outlined-basic'
